...
def visualize_results(stock_data, trade_history, performance_stats):
    ...
    ax.plot(
        trade_history.loc[trade_history["signal"] == "BUY"].index,
    ...
    ax.plot(
        trade_history.loc[trade_history["signal"] == "SELL"].index,
    ...
    ax.plot(
        trade_history.loc[trade_history["trade_type"] == TradeType.BUY].index,
    ...
    ax.plot(
        trade_history.loc[trade_history["trade_type"] == TradeType.SELL].index,
